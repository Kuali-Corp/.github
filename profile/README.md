...
**MAUZ** es la división especializada en ingeniería y desarrollo de software a medida de **Grupo Första**. Nos encargamos de transformar requerimientos empresariales complejos en productos digitales rentables, estables y de alto impacto comercial.
...
* **[Första Labs](https://github.com/SoodanCompany):** Nuestro laboratorio de innovación. El espacio dedicado al testeo de conceptos arquitectónicos complejos, pruebas de concepto (PoC) y el desarrollo de aplicaciones de autoría propia.
...
---
*MAUZ es una empresa de Grupo Första. ¿Tienes un proyecto en mente? Contáctanos.*
